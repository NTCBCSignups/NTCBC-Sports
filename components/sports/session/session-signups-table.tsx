                  ...
                  return (
                    <Fragment key={signup.id}>
                      ...
                      <TableRow className={`group ${isCurrentUser ? "bg-status-info" : ""}`}>
                        <TableCell className="font-mono text-xs">{groupIndex}</TableCell>
                        ...
                        <TableCell
                          className={`sticky right-0 border-l group-hover:bg-muted ${isCurrentUser ? "bg-status-info" : "bg-card"}`}
                        >
                          <div className="flex items-center justify-between gap-1">
                            <StatusBadge
                              status={signup.status as "confirmed" | "waitlisted" | "declined"}
                            />
