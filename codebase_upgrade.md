...
This is a well-architected Next.js App Router project with strong conventions (data-driven config, centralized queries, clean auth). The surrounding infrastructure to _keep_ it good is partially in place — testing and CI are now covered. Remaining gaps are linting/formatting and some minor organizational/security items.
