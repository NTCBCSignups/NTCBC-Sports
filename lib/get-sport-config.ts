import "server-only";
import { resolveSportConfigRow, type ResolvedSportConfig } from "@/config/config-resolver";
 ...
 */
export async function getResolvedSportsConfigBySport(): Promise<
  Record<string, ResolvedSportConfig>
> {
